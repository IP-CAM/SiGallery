...
class ControllerModuleSigallery extends Controller {
  ...
  PRIMARY KEY (`sigallery_image_id`,`language_id`)
		...
		$this->db->query("CREATE TABLE `" . DB_PREFIX . "sigallery_path` (
  `sigallery_id` int(11) NOT NULL,
...
(1, 1, 'root', '', '', '', '', '');");
		$this->db->query("INSERT INTO `" . DB_PREFIX . "sigallery_path` (`sigallery_id`, `path_id`, `level`) VALUES (1, 1, 0);");
    }
	...
	public function uninstall() {
		...
		$this->db->query("DROP TABLE IF EXISTS `" . DB_PREFIX . "sigallery_path`;");
	}
